            ...
            <div className="relative z-10 mx-auto my-auto grid grid-cols-1 lg:grid-cols-[2fr_1.5fr] gap-8 lg:gap-10 max-w-7xl px-6 md:px-10 py-20 lg:py-0">
                ...
                >
                    ...
                    <motion.div className="mt-8 lg:mt-10 flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center lg:justify-start" variants={itemVariants}>
                        <a 
                            href="/Susilkumar_Resume.pdf" 
                            download="Susilkumar_Resume.pdf"
                            className="group relative px-8 lg:px-10 py-3 text-base lg:text-lg bg-gradient-to-r from-blue-600 to-purple-600 
                            rounded-full text-white font-semibold overflow-hidden text-center
                        ...
                        <a 
                            href="#contact"
                            className="px-8 lg:px-10 py-3 text-base lg:text-lg border-2 border-white/20 bg-white/5 backdrop-blur-sm
                    ...
                    <motion.div className="mt-6 lg:mt-8 flex gap-3 sm:gap-4 justify-center lg:justify-start" variants={itemVariants}>
                        ...
                        <a
                            href='https://leetcode.com/u/s_susilkumar/'
                            target='_blank'
