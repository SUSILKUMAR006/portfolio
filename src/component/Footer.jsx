        ...
        <footer className='bg-[#020617] border-t border-white/10'>
            <div className='max-w-7xl mx-auto px-6 md:px-10 py-8 md:py-12'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8'>
                  ...
                  hover:bg-white/10 hover:border-white/30 transition-all duration-300 hover:scale-110'>
                  ...
                  hover:bg-white/10 hover:border-white/30 transition-all duration-300 hover:scale-110'>
                            ...
                            <a href='https://instagram.com' target='_blank' rel='noopener noreferrer'
                                className='w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center
                  hover:bg-white/10 hover:border-white/30 transition-all duration-300 hover:scale-110'>
                                <svg className='w-5 h-5' fill='url(#footer-instagram-gradient)' viewBox='0 0 24 24'>
                                    <defs>
